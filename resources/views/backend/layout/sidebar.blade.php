        <ul id="side-main-menu" class="side-menu list-unstyled d-print-none">
            ...
            <ul id="product" class="collapse list-unstyled ">
                ...
                <li id="category-menu"><a href="{{route('category.style')}}"> Product Style</a></li>
                @endif
                @if($index_permission_active)
                <li id="product-list-menu"><a href="{{route('currentStock')}}">Current List</a></li>
                <?php
                    $add_permission_active = $role_has_permissions_list->where('name', 'products-add')->first();
                ?>
                @if($add_permission_active)
                <li id="product-create-menu"><a href="{{route('addNewProduct')}}"> Add New Product</a></li>
                @endif
                @endif
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
                    ...
                    <li id="brand-menu"><a href="{{route('brand.index')}}"> Buyer </a></li>
                    @endif
